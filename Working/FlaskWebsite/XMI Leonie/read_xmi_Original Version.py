...
Original file is located at
    https://colab.research.google.com/drive/1KkCUQBE2T3vHEP6PegYYkj9Z1o_MTcQh
"""
...
path_to_xmi_files ='' #TODO: If the files are not in the same folder as the code file, add path to file.
...
# read new model
with open('new_file/ID8_mit Applikation_fake.xmi', 'r') as file: # TODO: specify new model path
    content = file.read()
